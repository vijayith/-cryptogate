...
const useEvm = () => {
    ...
    const setData = (_account, _chainId, _provider) => {
        ...
        _provider && setProvider(new ethers__namespace.providers.Web3Provider(_provider, 'any'));
    };
    ...
    const activateCoinbaseWallet = React__default["default"].useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // appLogo is optional
            ...
            const _coinbase = new CoinbaseWalletSDK__default["default"]({
                appName: "OasisX",
    ...
    const activateWalletConnect = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        provider.on("connect", () => setProvider(new ethers__namespace.providers.Web3Provider(provider, 'any')));
